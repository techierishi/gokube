...
func init() {
	...
	managerCmd.Flags().StringSliceP("workers", "w", []string{"localhost:5556"}, "List of workers on which the manger will schedule tasks.")
...
var managerCmd = &cobra.Command{
	Use:   "manager",
	Short: "Manager command to operate a gokube manager node.",
	Long: `gokube manager command.
